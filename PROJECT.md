...
| Aspect | Detail |
|--------|--------|
| **Provider** | **Refine Core + shadcn/ui inside the TanStack app — P2 (done 2026-08-15)**; mock mode: MockAdminPanel for full admins (+ `?admin=refine` preview), Refine shell for limited roles; historical: Strapi redirect shell |
