...
import {
  FileText, Eye, Edit3, Plus, LayoutDashboard, BookOpen, Globe, Users, Video, MessageSquare, ArrowRight, Clock, PenSquare, Upload, BarChart3,
} from "lucide-react";
...
function AdminDashboard() {
  ...
  const quickActions = [
    { to: "/admin/posts", label: "All Posts", icon: PenSquare, color: "bg-blue-50 text-blue-700 dark:bg-blue-950/30 dark:text-blue-400" },
    { to: "/admin/pages", label: "Pages", icon: Globe, color: "bg-emerald-50 text-emerald-700 dark:bg-emerald-950/30 dark:text-emerald-400" },
