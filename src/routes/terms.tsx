      ...
      <Reveal delay={0.2}>
        <div className="mt-12 rounded-2xl border border-border/60 bg-card p-6 md:p-10 shadow-sm prose-mitra space-y-8 text-sm text-muted-foreground leading-relaxed">
          {lang === "bn" ? (
            <>
              <section>
                <h2 className="font-serif text-lg text-foreground mb-3">১. সেবা বর্ণনা</h2>
              ...
              <section>
                <h2 className="font-serif text-lg text-foreground mb-3">২. ব্যবহারের শর্তাবলী</h2>
              ...
              <section>
                <h2 className="font-serif text-lg text-foreground mb-3">৩. বৌদ্ধিক সম্পত্তি</h2>
              ...
              <section>
                <h2 className="font-serif text-lg text-foreground mb-3">৪. অ্যাকাউন্ট</h2>
                <p>আপনার অ্যাকাউন্টের নিরাপত্তা বজায় রাখা আপনার দায়িত্ব। আপনি আপনার অ্যাকাউন্টের কার্যকলাপের জন্য দায়ী।</p>
              </section>

              <section>
                <h2 className="font-serif text-lg text-foreground mb-3">৫. পেমেন্ট ও রিফান্ড</h2>
              ...
              <section>
                <h2 className="font-serif text-lg text-foreground mb-3">৬. দায়মুক্তি</h2>
            ...
            <>
              <section>
                <h2 className="font-serif text-lg text-foreground mb-3">1. Description of Service</h2>
              ...
              <section>
                <h2 className="font-serif text-lg text-foreground mb-3">2. Terms of Use</h2>
                <p>By using the platform, you agree to be bound by these terms. You will only use the platform for lawful purposes.</p>
              </section>

              <section>
                <h2 className="font-serif text-lg text-foreground mb-3">3. Intellectual Property</h2>
              ...
              <section>
                <h2 className="font-serif text-lg text-foreground mb-3">4. Accounts</h2>
              ...
              <section>
                <h2 className="font-serif text-lg text-foreground mb-3">5. Payments & Refunds</h2>
              ...
              <section>
                <h2 className="font-serif text-lg text-foreground mb-3">6. Disclaimer</h2>
