...
export function TextareaField({ label, value, onChange, hint }: {
...
export function RichTextField({ label, value, onChange }: {
...
export function FileUploadField({ label, value, onUpload, onClear, onUrl, previewClass }: {
  label: string;
  value: string;
