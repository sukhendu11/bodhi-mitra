...
export function SocialShare({ url, title, description }: SocialShareProps) {
  ...
  return (
    <div ref={menuRef} className="relative">
      ...
      {open && (
        <div className="absolute right-0 top-full mt-2 z-50 w-52 rounded-xl border border-border/80 bg-popover text-popover-foreground shadow-2xl ring-1 ring-foreground/5 p-2 animate-in fade-in slide-in-from-top-1 duration-200">
