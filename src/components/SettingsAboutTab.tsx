...
import { Field, FieldRow, FileUploadField, RichTextField, Section, TextareaField } from "@/components/SettingsFields";
    ...
    <>
      <Section title="About Page — Hero">
        ...
        <FileUploadField
          ...
          onUpload={async (f) => { const url = await uploadAsset(f, "about"); if (url) update("about", { image_url: url }); }}
