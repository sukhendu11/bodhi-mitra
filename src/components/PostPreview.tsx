...
export function PostPreview({
  ...
  const previewStyle =
    tab === "bn" ? { fontFamily: "var(--font-bn)", letterSpacing: 0 } : undefined;
    ...
    <div className="space-y-6 max-w-3xl">
      ...
      <article className="mx-auto max-w-2xl py-10">
        <header className="mb-10 text-center">
          ...
          <p className="mt-6 text-sm text-muted-foreground">by {authorName || authorFallback}</p>
          {tags.length > 0 && (
        ...
        {excerpt && (
          <p
            className="font-serif text-xl text-foreground/80 italic text-center mb-8"
            style={previewStyle}
          >
            {excerpt}
          </p>
