...
export function SeoTab({ cfg, update, uploadAsset }: TabProps): ReactNode {
  return (
    <>
      ...
      <Section title="Sitemap" desc="Generate a dynamic sitemap.xml for search engines. Disable if you prefer to supply your own.">
        ...
        {cfg.seo.enable_sitemap && (
          <p className="mt-2 text-[0.6rem] text-muted-foreground/60">
            Your sitemap is available at <code className="text-foreground/70">/sitemap.xml</code> and robots.txt at <code className="text-foreground/70">/robots.txt</code>.
          </p>
        )}
      </Section>
    </>
